...
// the maintainer's deliberate, dated journal (see workshop-gremlin.md's Risks note:
// entries are written, not machine-generated from session logs). The glob loader
// reads it in place; nothing is duplicated into src/.
